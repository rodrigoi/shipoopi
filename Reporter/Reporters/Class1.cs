...
namespace GeneratedCode
{
    public class GeneratedClass
    {
        ...
        private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
        {
            ...
            WorkbookView workbookView1 = new WorkbookView() { XWindow = 240, YWindow = 120, WindowWidth = (UInt32Value)20115U, WindowHeight = (UInt32Value)7995U };
        ...
        private void GenerateWorkbookStylesPart1Content(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            BackgroundColor backgroundColor1 = new BackgroundColor() { Rgb = "FFC6EFCE" };
            ...
            BackgroundColor backgroundColor2 = new BackgroundColor() { Rgb = "FFFFC7CE" };
        ...
        private void GenerateWorksheetPart1Content(WorksheetPart worksheetPart1)
        {
            ...
            Selection selection1 = new Selection() { ActiveCell = "B6", SequenceOfReferences = new ListValue<StringValue>() { InnerText = "B6" } };
            ...
            ConditionalFormatting conditionalFormatting1 = new ConditionalFormatting() { SequenceOfReferences = new ListValue<StringValue>() { InnerText = "A1:A2" } };

            ConditionalFormattingRule conditionalFormattingRule1 = new ConditionalFormattingRule() { Type = ConditionalFormatValues.CellIs, FormatId = (UInt32Value)0U, Priority = 2, Operator = ConditionalFormattingOperatorValues.GreaterThan };
            Formula formula1 = new Formula();
            formula1.Text = "0";

            conditionalFormattingRule1.Append(formula1);

            ConditionalFormattingRule conditionalFormattingRule2 = new ConditionalFormattingRule() { Type = ConditionalFormatValues.CellIs, FormatId = (UInt32Value)1U, Priority = 1, Operator = ConditionalFormattingOperatorValues.LessThan };
        ...
        {
            document.PackageProperties.Creator = "Obi-Wan Kenobi";
            document.PackageProperties.LastModifiedBy = "Obi-Wan Kenobi";
        }
